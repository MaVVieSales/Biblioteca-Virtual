      ...
      <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
        <Card style={[styles.card, { backgroundColor: theme.colors.cardBackground }]}>
          ...
          <Card.Content style={styles.cardContent}>
            ...
            {item.curso && (
              <Text style={[styles.cardCourse, { color: theme.colors.text }]} numberOfLines={2}>
                {item.curso}
              </Text>
            )}
          </Card.Content>
...
const Museu = ({ navigation }) => {
  ...
  const renderCard = ({ item }) => (
    <AnimatedTCCCard item={item} navigation={navigation} theme={theme} />
  );
